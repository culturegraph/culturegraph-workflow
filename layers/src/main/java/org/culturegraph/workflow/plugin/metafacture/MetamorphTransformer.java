...
public class MetamorphTransformer implements Transformer {
    private static final Logger LOG = LoggerFactory.getLogger(MetamorphTransformer.class);

    private DefaultObjectPipe<String, StreamReceiver> decoder;
    private StringConcatenator resultCollector;

    public MetamorphTransformer(DefaultObjectPipe<String, StreamReceiver> decoder, StringConcatenator resultCollector) {
